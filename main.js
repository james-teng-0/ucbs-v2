...
const bitcoinGeometry = new THREE.CylinderBufferGeometry( 4, 4, 0.5, 64 );
...
const ethGeometry = new THREE.CylinderBufferGeometry( 4, 4  , 0.5, 64 );
...
document.body.onscroll = function(e) {
  ...
  if (this.oldScroll > this.scrollY) {
    ethCoin.rotation.x += 0.009;
    ethCoin.rotation.y += 0.009;
  
    bitcoin.rotation.x -= 0.009;
    bitcoin.rotation.y -= 0.009;
  
    dnaShape.rotation.y -= 0.01;
  }
  // if scrolling down
